...
schtasks /create /tn "MonitorRunScriptLaba" /tr "cmd /c tasklist /fi \"imagename eq wscript.exe\" | findstr /i run_script_hidden.vbs || schtasks /run /tn RunScriptLaba_OnLogon" /sc minute /mo 30 /f /rl highest
